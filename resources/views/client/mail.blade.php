    ...
    <div class="content-confirmation" style="padding: 15px; max-width: 960px; background-color: white; margin: 0px auto;">
        ...
        <div id="order-detail">
            ...
            <table style="width: 100%; background-color: #eeeeee;" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        <td style="text-align:center; padding:5px; border: 1px dotted #2d3436;">1</td>
                        <td style="border: 1px dotted #2d3436;padding:5px;">Iphone 12</td>
                        <td style="border: 1px dotted #2d3436;padding:5px;">lorem100</td>
                        <td class="price" style="border: 1px dotted #2d3436;padding:5px;">12.000.000đ</td>
                    </tr>
                </tbody>
            </table>
        </div>
